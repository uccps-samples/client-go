...
func (c *SharedresourceV1alpha1Client) SharedConfigMaps() SharedConfigMapInterface {
	return newSharedConfigMaps(c)
}

func (c *SharedresourceV1alpha1Client) SharedSecrets() SharedSecretInterface {
...
// NewForConfigAndClient creates a new SharedresourceV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SharedresourceV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
