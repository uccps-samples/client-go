...
var configsResource = schema.GroupVersionResource{Group: "samples.operator.uccp.io", Version: "v1", Resource: "configs"}

var configsKind = schema.GroupVersionKind{Group: "samples.operator.uccp.io", Version: "v1", Kind: "Config"}
