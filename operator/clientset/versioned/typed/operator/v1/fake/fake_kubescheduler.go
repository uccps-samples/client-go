...
var kubeschedulersResource = schema.GroupVersionResource{Group: "operator.uccp.io", Version: "v1", Resource: "kubeschedulers"}

var kubeschedulersKind = schema.GroupVersionKind{Group: "operator.uccp.io", Version: "v1", Kind: "KubeScheduler"}
