...
type SharedInformerFactory interface {
	...
	Controlplane() operatorcontrolplane.Interface
}

func (f *sharedInformerFactory) Controlplane() operatorcontrolplane.Interface {
	return operatorcontrolplane.New(f, f.namespace, f.tweakListOptions)
}
