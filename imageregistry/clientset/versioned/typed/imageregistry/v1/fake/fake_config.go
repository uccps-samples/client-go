...
var configsResource = schema.GroupVersionResource{Group: "imageregistry.operator.uccp.io", Version: "v1", Resource: "configs"}

var configsKind = schema.GroupVersionKind{Group: "imageregistry.operator.uccp.io", Version: "v1", Kind: "Config"}
